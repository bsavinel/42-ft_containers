...
/*   Updated: 2022/10/08 16:25:27 by bsavinel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	class set
	{
		public:
			...
			typedef	ft::Iterator_set<T, Alloc>						iterator;
			typedef	ft::Iterator_set<T, Alloc>						const_iterator;
		...
		private:
			RBT_set<value_type, Compare, Alloc>	_tree;
			key_compare							_comp;
